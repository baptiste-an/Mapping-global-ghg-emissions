...
(
    data.stack()
    .unstack(level="LY name")[right_index]
    .unstack()
    .stack(level=0)["value"]
    .sum()
    - data.stack()
...
(
    SLY[["LkY Government", "LkY Households", "LkY NCF", "LkY NPISHS"]].sum().sum()
    - SLY[["LY Government", "LY Households", "LY NCF", "LY NPISHS", "LY CFC"]]
    .sum()
    .sum()
)

(
    SLY[["LkY Government", "LkY Households", "LkY NCF", "LkY NPISHS"]].abs().sum().sum()
    - SLY[["LY Government", "LY Households", "LY NCF", "LY NPISHS", "LY CFC"]]
    .abs()
    .sum()
    .sum()
