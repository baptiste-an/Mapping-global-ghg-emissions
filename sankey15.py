...
def Kbar():
    ...
    Kbarcoefs = (Kbar15.div(Kbar15.sum(), axis=1)).stack()  # stacked because we need to access CY later
    ...
    Kbarcoefs["CY"] = Kbar14.div(Kbar14.sum(), axis=1).stack()["CY"]  # because wrong data for CY in Kbar15
